...
async function verifyUPIPayment(order) {
    ...
    return new Promise((resolve, reject) => {
        ...
        const amount = order.total * 100;  // Paisa mein
        const currency = "INR";
        const receipt = order.id;

        // Backend call (agar hai) ya hardcoded
        const options = {
            ...
            handler: async function(response) {
                try {
                    // Payment successful - verify signature (if backend)
            ...
            // Prefill - Auto-fill user details
            prefill: {
            ...
            // Theme - Branding
            theme: {
                color: "#0ca88f"  // ChemistBoys green
            },
